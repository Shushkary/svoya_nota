...
(async () => {
  ...
  await page.locator('summary.n-panel-label', { hasText: 'вчерашние приёмы' }).click();
  ...
  await page.locator('summary.n-panel-label', { hasText: 'день · ориентиры' }).click();
  ...
  await activityPanel.locator('summary.n-panel-label').click();
